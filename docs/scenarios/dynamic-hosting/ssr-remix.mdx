...
We are going to deploy a remix run react router serverless ssr app to a lambda function and drop the client assets in an s3 bucket with cloudfront cdn routing.
